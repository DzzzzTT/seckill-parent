...
public class SeckillProducts{
  ...
  //status对应的值
  public static Integer STATUS_IS_ONLINE = 1;  //在线
  public static Integer STATUS_IS_OFFLINE = 2;  //离线
  public static Integer STATUS_IS_FINISHED = 3;  //完成
