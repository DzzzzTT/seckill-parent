...
public class EntityUtil {
    ...
    private final String bean_path = "D:\\Idea\\work\\seckill-parent-xbc\\seckill-service\\src\\main\\java";

    private final String mapper_path = "D:\\Idea\\work\\seckill-parent-xbc\\seckill-service\\src\\main\\java\\com\\bmw\\seckill\\dao";

    private final String xml_path = "D:\\Idea\\work\\seckill-parent-xbc\\seckill-service\\src\\main\\resources\\mapping";// xml路径
    ...
    private final String password = "2464";// "root";//数据库密码

    private final String url = "jdbc:mysql://localhost:3306/" + moduleName + "?useUnicode=true&characterEncoding=UTF-8&serverTimezone=UTC";
